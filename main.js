...
let icons = document.querySelectorAll('.col-custom >i');

console.log(icons);

let columns = document.querySelectorAll('.col-custom');

columns.forEach( (colonna, index)=>{

    colonna.addEventListener('mouseenter', ()=>{

        icons[index].classList.add('text-whiteC');
        icons[index].classList.remove('text-secondaryC');
         
    })

    colonna.addEventListener('mouseleave', ()=>{

        icons[index].classList.remove('text-whiteC');
        icons[index].classList.add('text-secondaryC');
